...
const PropSchema = ats.schema('ShopifyIconProps', {
  width: ats.number().optional().default(24, 'Icon width'),
  height: ats.number().optional().default(24, 'Icon height'),
  fill: ats.color().optional().default('#95bf47', 'Icon fill color'),
})

/* --- <ShopifyIcon/> -------------------------------------------------------------------------- */

const ShopifyIcon = ({ fill = '#95bf47', ...props }: Infer<typeof PropSchema>) => (
  <Svg width={24} height={24} viewBox="0 0 109.5 124.5" fill={fill} {...props}>
