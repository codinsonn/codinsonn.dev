...
<details>
  <summary><b>🤔 So... why did I start with a hybrid first approach?</b></summary>
...
4. [Shared and platform specific **routing for Expo & Next.js**](?path=/docs/aetherspace-universal-routing--page)
5. [GraphQL and API routes -- **Schemas and single sources of truth**](?path=/docs/aetherspace-graphql-data-fetching--page)
6. [Automatic **docs generation** for components and data apis](?path=/docs/aetherspace-automation--page) 
7. [CI & near instant **Deploys for web and App Stores** -- With Expo & Turborepo](?path=/docs/aetherspace-deployment--page)
