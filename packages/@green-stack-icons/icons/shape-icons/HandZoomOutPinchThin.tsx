...
/* --- <HandZoomOutPinchThin/> ----------------------------------------------------------------- */

export const HandZoomOutPinchThin = ({ size = 24, fill = '#333333', ...svgProps }: IconProps) => (
  <Svg width={size} height={size} fill="none" viewBox="0 0 24 24" {...svgProps}>
    <Path stroke={fill} strokeLinecap="round" strokeLinejoin="round" d="m2 10 3-3" />
    <Path
      stroke={fill}
      strokeLinecap="round"
      ...
      d="M5 9.828V7H2.172"
    />
    <Path stroke={fill} strokeLinecap="round" strokeLinejoin="round" d="m7 5 3-3" />
    <Path
      stroke={fill}
      strokeLinecap="round"
      strokeLinejoin="round"
