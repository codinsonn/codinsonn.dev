...
/* --- <NotificationTick2Thin/> ---------------------------------------------------------------- */

export const NotificationTick2Thin = ({ size = 24, fill = '#333333', ...svgProps }: IconProps) => (
  <Svg width={size} height={size} fill="none" viewBox="0 0 24 24" {...svgProps}>
    ...
    />
    <Path stroke={fill} strokeMiterlimit={10} d="m8.6 9.23 2.55 2.55 4.25-4.25" />
  </Svg>
)
