...
export const ServerUnsuccessThin = ({ size = 24, fill = '#333333', ...svgProps }: IconProps) => (
  <Svg width={size} height={size} fill="none" viewBox="0 0 24 24" {...svgProps}>
    ...
    />
    <Path stroke={fill} strokeLinejoin="round" d="M5 4v2M8 4v2M5 11v2M8 11v2M5 18v2M8 18v2" />
    <Path
      stroke={fill}
      strokeLinecap="round"
      strokeLinejoin="round"
