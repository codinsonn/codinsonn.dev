...
export const InstagramFilled = ({
  ...
  <Svg width={size} height={size} fill="none" viewBox="0 0 24 24" {...svgProps}>
    ...
    <Path stroke={stroke} strokeLinejoin="round" d="M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z" />
    <Path fill={fill} d="M18 5.5a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1Z" />
    <Path stroke={stroke} strokeLinejoin="round" d="M18 5.5a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1Z" />
  </Svg>
)
