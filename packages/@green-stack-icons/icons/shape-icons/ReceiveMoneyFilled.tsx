...
export const ReceiveMoneyFilled = ({
  size = 24,
  fill = '#333333',
  stroke = '#FFFFFF',
  ...svgProps
  ...
  >
    ...
    <Path
      fill={fill}
      fillRule="evenodd"
      d="M5.707 15.293a1 1 0 0 1 0 1.414L3.414 19l2.293 2.293a1 1 0 1 1-1.414 1.414l-3-3a1 1 0 0 1 0-1.414l3-3a1 1 0 0 1 1.414 0Z"
      clipRule="evenodd"
    />
  </Svg>
)
