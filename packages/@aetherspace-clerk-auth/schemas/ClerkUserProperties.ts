...
export const ClerkUserProperties = aetherSchema('ClerkUserProperties', {
  ...
  emailAdresses: ClerkUserEmailAdress.array().describe(d.emailAdresses),
  hasVerifiedEmailAddress: z.boolean().describe(d.hasVerifiedEmailAddress),
  ...
  hasVerifiedPhoneNumber: z.boolean().describe(d.hasVerifiedPhoneNumber),
  externalAccounts: ClerkExternalAccount.array().describe(d.externalAccounts),
  verifiedExternalAccounts: ClerkExternalAccount.array().describe(d.verifiedExternalAccounts),
  unverifiedExternalAccounts: ClerkExternalAccount.array().describe(d.unverifiedExternalAccounts),
  // samlAccounts: z.object({}).nullish().describe(d.samlAccounts),
  organizationMemberships: ClerkOrganizationMembership.array().describe(d.organizationMemberships),
  passwordEnabled: z.boolean().describe(d.passwordEnabled),
  totpEnabled: z.boolean().describe(d.totpEnabled),
  twoFactorEnabled: z.boolean().describe(d.twoFactorEnabled),
  backupCodeEnabled: z.boolean().describe(d.backupCodeEnabled),
  createOrganizationEnabled: z.boolean().describe(d.createOrganizationEnabled),
  deleteSelfEnabled: z.boolean().describe(d.deleteSelfEnabled),
